  ...
  return (
    <>
      ...
      <label htmlFor="my-modal" className="modal">
        <label htmlFor="" className="modal-box bg-white rounded-md lg:w-lg lg:py-16 lg:px-20 max-w-5xl max-h-4/5 overflow-y-auto overflow-x-hidden w-11/12">
          <div className="p-6 bg-gray-200"></div> <br /> <br />
          ...
          <div className={`w-full ${(!nextPage) ? 'hidden' : ''} font-poppins`}>
            ...
            <div className={`border-gray-400 rounded border py-3 lg:w-3/4 w-full transition duration-500 overflow-hidden ${(usernameOpen)?'h-fit':'h-18'}`}>
              <div
                className="px-5 py-3 border-b border-gray-300 flex justify-between"
              >
                <h2 className="font-bold text-xl">
                  UserName <span className="font-normal text-sm text-gray-600">required</span>
                </h2>
                <div className="flex">
                  <i className="text-lg rounded-full p-2 flex justify-center items-center transition duration-200 hover:bg-gray-200"><CgLoadbar /></i>
                  <i
              ...
              <div className="flex w-full px-3 py-1 justify-between items-end flex-wrap">
                <div className="lg:w-sectwo lg:mb-0 mb-1">
                  <p className="text-gray-900 text-lg ml-4 mb-1">
                    Filled Name <span className="text-sm text-gray-500 font-thin">required</span>
                  </p>
                  <input 
                  type="text" 
                ...
                <div className="flex w-40 bg-gray-200 p-3 rounded-sm items-center">
                  <input type="checkbox" className="checkbox checkbox-sm rounded-sm no-animation mr-2" />
              ...
              <div className="flex w-full px-3 py-1 justify-between items-end flex-wrap">
                <div className="lg:w-sectwo lg:mb-0 mb-1">
                  <p className="text-gray-900 text-lg ml-4 mb-1">
                    Error Message <span className="text-sm text-gray-500 font-thin">required</span>
                  </p>
                  <input 
                  type="text" 
                  className="input w-full border text-gray-800 focus:outline-none text-sm border-gray-300 rounded-sm" 
            ...
            <div className="border border-gray-400 rounded py-3 lg:w-3/4 w-full">
              ...
              >
                <h2 className="font-bold text-xl">
                  Password <span className="font-normal text-sm text-gray-600">required</span>
                </h2>
                <div className="flex">
                  <i className="text-lg rounded-full p-2 flex justify-center items-center transition duration-200 hover:bg-gray-200"><CgLoadbar /></i>
                  <i
                    className={`text-xl font-bold rounded-full p-2 flex justify-center items-center transition duration-200 hover:bg-gray-200 hover:rotate-180 cursor-pointer`}
                  >
                    <IoIosArrowDown />
                  </i>
                </div>
          ...
          <div className="flex">
            <button
              ...
              <i className="text-lg"><BsArrowLeft /></i> Back
            </button>

            <button
              className={`btn no-animation rounded-sm bg-gray-100 border-0 ${(!nextPage) ? 'hover:bg-gray-200' : 'hover:bg-gray-100'} text-black text-sm p-0 w-40 font-poppins ${(!nextPage) ? '' : 'hidden'}`}
              onClick={(e) => {
                setNextPage(!nextPage)
            ...
            <button
              ...
              Publish <i className="text-lg"><BsArrowRight /></i>
            </button>
          </div>
        </label>
      </label>
